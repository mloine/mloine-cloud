package com.mloine.msclass.jwt;
...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1NzY4MjQ0MzYsImV4cCI6MTU3ODAzNDAzNn0.ZzZVE8fNahEuRS7XlzLqqujmq_KzMvNsjISW_-SX5ww";
        ...
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE1NzY4MjQ1MjcsImV4cCI6MTU3ODAzNDEyN30";
        // 测试5: 解密Payload
        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
        System.out.println(new String(payload));

        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
        jwtOperator.validateToken("eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1NzY4MjQ1ODMsImV4cCI6MTU3ODAzNDE4M30.yGjO66C8iFQz9e8QEvPBb8hEmdPBhVDrgXefZG85DaU");
    }
}
